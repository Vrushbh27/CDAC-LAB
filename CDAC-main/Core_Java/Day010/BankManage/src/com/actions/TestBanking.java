...
//				calling SavingBank Account Constructor	
				BankAccount saving = new SavingAccount(101, 1000, name, PhoneNumber, 7, AccountType.SAVING);
				bank[index] = saving;
				index++;
...
//				 calling CurrentBank Account Constructor	
				BankAccount current = new CurrentAccount(102, 1000, name, PhoneNumber, 5000, AccountType.CURRENT);
				bank[index] = current;
				index++;
