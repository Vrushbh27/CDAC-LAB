			...
			do {
				...
				try {
					...
					case 1:
						...
						bankService.openAccount(106, 2000, "dummy1", "454456565", 7, "SAVING");
						bankService.openAccount(102, 1000, "dummy2", "65254456565", 7, "SAVING");
						break;

					case 2:
						System.out.println("Enter the Account Number, initialBalance name mobileNumber : ");
						bankService.openAccount(101, 1000, "dummy1", "2254456565", 5000, "current");
						bankService.openAccount(104, 1000, "dummy2", "16554456565", 5000, "current");
						break;
