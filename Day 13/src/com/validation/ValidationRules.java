...
import com.bank.hdfc.AccountType;
import com.bank.hdfc.BankAccount;
import com.bankexceptions.BankException;
import java.util.*;

public class ValidationRules {
    private static final double SAVINGS_MIN_BALANCE = 100;


    // Duplicate account validation
    public static void validateDuplicate(List<BankAccount>accounts, String accountNum) throws BankException {
    ...
    public static void validateSavingsBalance(double balance) throws BankException {
        ...
        if(balance < SAVINGS_MIN_BALANCE) {
            throw new BankException("Savings Account requires a minimum balance of $" + SAVINGS_MIN_BALANCE);
        }
    }
    ...
    public static void ValidateInterestRate(double interestRate) throws BankException
    {
        if(interestRate >= 28)
        {
            throw new BankException("Unacceptable Interest Rate!!!");
        }
    }
